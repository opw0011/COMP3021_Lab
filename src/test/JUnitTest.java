...
public class JUnitTest {
	...
	public void testCountLetters() {
		TextNote tn1 = new TextNote("a", "bbbbC DEE*~(");
		char c1 = tn1.countLetters();
		assertEquals("The most frequent letter is not matched", 'b', c1);
		TextNote tn = new TextNote("a", "");
		char c = tn.countLetters();
		assertEquals("The most frequent letter is not matched", 'a', c);
