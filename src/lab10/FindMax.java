...
public class FindMax {
	...
	public void printMaxMT() {
		FindMaxTask task1 = new FindMaxTask(0, 29);
		FindMaxTask task2 = new FindMaxTask(30, 59);
		FindMaxTask task3 = new FindMaxTask(60, 89);
		...
		int[] arr = new int[3];
		arr[0] = task1.getOutput();
		arr[1] = task2.getOutput();
		arr[2] = task3.getOutput();
		int max = arr[0];
	...
	// Inner class
	private class FindMaxTask implements Runnable {
		...
		public void run() {
			...
			output = new FindMax().findMax(begin, end);
		}
	}
}
